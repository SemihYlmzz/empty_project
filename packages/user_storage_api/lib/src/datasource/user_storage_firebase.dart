...
class UserStorageFirebaseInitializer {
  Future<UserStorageFirebase> initialize({
    FirebaseStorage? firebaseStorage,
  }) async {
    await Firebase.initializeApp();
    return UserStorageFirebase(
      firebaseStorage: firebaseStorage,
    );
  }
}

class UserStorageFirebase implements UserStorageApi {
  UserStorageFirebase({
    FirebaseStorage? firebaseStorage,
