...
class _$CurrentLocationModelImpl implements _CurrentLocationModel {
  const _$CurrentLocationModelImpl(
  ...
  @override
  String toString() {
    return 'CurrentLocationModel(longitude: $longitude, latitude: $latitude)';
  }
...
abstract class _CurrentLocationModel implements CurrentLocationModel {
  const factory _CurrentLocationModel(
      ...
      required final double latitude}) = _$CurrentLocationModelImpl;
