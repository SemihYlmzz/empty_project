...
_$UserDatabaseModelImpl _$$UserDatabaseModelImplFromJson(
        Map<String, dynamic> json) =>
    _$UserDatabaseModelImpl(
...
Map<String, dynamic> _$$UserDatabaseModelImplToJson(
        _$UserDatabaseModelImpl instance) =>
    <String, dynamic>{
      'uid': instance.uid,
